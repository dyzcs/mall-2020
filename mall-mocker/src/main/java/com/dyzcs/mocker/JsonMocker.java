package com.dyzcs.mocker;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.dyzcs.utils.RanOpt;
import com.dyzcs.utils.RandomDate;
import com.dyzcs.utils.RandomNum;
import com.dyzcs.utils.RandomOptionGroup;
import com.dyzcs.uploader.LogUpLoader;
...
public class JsonMocker {
    ...
    //
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new RanOpt("addComment", 30), new RanOpt("addCart", 20), new RanOpt("clickItem", 10), new RanOpt("coupon", 80)};
